...
public class lingo2 : MonoBehaviour
{
    public static lingo2 instance;
    ...
    public void changetitletext()
    {
        ...
        {
            Debug.Log("-------------------------------------------------------------------");
            int randompoistion = Random.Range(0, btns.Length);
        ...
        for (int i = 0; i < btns.Length; i++)
        {
            btns[i].transform.DOScale(Vector3.one*0.26f, 0.5f);
        }
